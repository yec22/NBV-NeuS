...
if __name__ == '__main__':
    ...
    parser.add_argument('--downsample_density', type=float, default=0.1)
    ...
    base_dir = "exp/blender/neus-blender-hotdog-sparse/@20231203-092430/save"
    args.dataset_dir = "/data/yesheng/3D-Scene/data/blender"
    ...
    for scan in scans:
        ...
        args.data = os.path.join(base_dir, f"eval_{scan}.ply")
        mesh = trimesh.load(os.path.join(base_dir, f"it10000-mc512.obj"))
        mesh.export(args.data)

        args.gt = os.path.join(args.dataset_dir, scan, f"{scan}.ply")
        args.scan = scan
